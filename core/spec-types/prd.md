...
frontmatter:
  required:
    - { name: title, type: string, required: true, classification: content, description: "One-line human title for the PRD." }
    - { name: type, type: enum, required: true, values: [prd], default: prd, classification: content, description: "Spec type discriminator; always 'prd'." }
  ...
  optional:
    ...
    - { name: kind, type: enum, values: [pitch, ten-section, lightweight], default: ten-section, classification: content, description: "PRD template variant." }
    ...
    - { name: relations, type: "list[relation]", classification: content, description: "Parent/child edges." }
---
