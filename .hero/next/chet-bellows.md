...
> Bug in the Hero repo (/Users/developer/projects/hero-engine/repository/hero): `parseSections` treats `## ` headings inside fenced code blocks as real section headings, forging phantom sections and silently truncating the preceding section's parsed content.
> 
