...
_Last refreshed: 2026-07-16T05:11:06Z · projected from 534 source nodes_

## Surfaces

| Surface | Stage | Path(s) | Last touched | Driver spec |
|---|---|---|---|---|
| core | building | cmd/, internal/ | 12m ago | satellite-corpus-integration |
...
| serve | building | internal/serve/ | 12m ago | agents-md-erased-by-snapshot-pointer-writer |
| (unassigned) | — | — | — | 207 specs without surface |
...
- **core** — layered-integration-configuration, harness-native-install-target-aware-upgrade, scan-clobbers-authored-created-slug-frontmatter
...
- **Unassigned specs (207) — no `surface:` declared.** Run `hero snapshot assign` to bucket them.

## Snapshot health

- Surfaces detected: 9 (inferred: 9 · overrides applied: 0)
- Specs covered: 191/398 (47%)
