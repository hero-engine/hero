...
_Last refreshed: 2026-06-02T14:44:17Z · projected from 288 source nodes_

## Surfaces

| Surface | Stage | Path(s) | Last touched | Driver spec |
|---|---|---|---|---|
| core | building | cmd/, internal/ | 13h ago | hero-local-merge-missing-dialect-fields |
...
- **Aged open bugs (3):** `hero-workspace-not-self-describing` (open 21d), `scan-enrichment-unbounded-loop` (open 21d), `scan-test-detection-misses-spock-vitest` (open 21d).
