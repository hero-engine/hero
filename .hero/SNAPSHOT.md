# Project Snapshot — hero-project-mail.dswyYE

> Hero is the sidekick brain for AI-augmented knowledge work.

_Last refreshed: 2026-08-24T14:07:11Z · projected from 669 source nodes_
_Last refreshed: 2026-08-23T01:01:22Z · projected from 525 source nodes_
...
| core | maturing | cmd/, internal/ | 15m ago | hero-runner |
| docs | maturing | web/docs/ | 15m ago | — |
| domains/chat | maturing | domains/chat/ | 15m ago | — |
| domains/engineering | maturing | domains/engineering/ | 15m ago | — |
| domains/pm | maturing | domains/pm/ | 15m ago | — |
| domains/qa | concept | domains/qa/ | — | — |
| domains/sales | maturing | domains/sales/ | 15m ago | — |
| landing | building | web/landing/ | 15m ago | hero-landing-page |
| mcp | concept | internal/serve/mcp*.go | — | — |
| serve | building | internal/serve/ | 15m ago | agent-outposts |
| (unassigned) | — | — | — | 248 specs without surface |
...
- **(unassigned)** — mock-tracker-server, gitlab-tracker-support, cev2-verbatim-turn-counting, cev2-protect-compaction-summaries, dual-mode-pm-qa-capability-packs, qa-public-pack, pm-public-pack, install-upgrade-contract-coverage
...
- **Unassigned specs (248) — no `surface:` declared.** Run `hero snapshot assign` to bucket them.
...
- Specs covered: 218/466 (46%)
- Projection generation: 1ms · Source nodes: 525
