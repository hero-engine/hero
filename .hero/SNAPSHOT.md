...
_Last refreshed: 2026-07-28T01:50:35Z · projected from 608 source nodes_
...
- **"Code Host Broker Capabilities — Hero-owned PR lifecycle boundary"** (surface: —) — 2/8 specs done; in flight: github-code-host-read-adapter
...
- **(unassigned)** — code-host-broker-v1-contract, code-host-integration-capability-model, windows-file-lock-cross-build, continuous-code-index-freshness, conversational-attention-operability, attention-contract-bundle-publication, attention-conversational-routes
...
2. **(unassigned)** — `github-code-host-read-adapter` (high, delivering)
