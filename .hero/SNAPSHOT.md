...
_Last refreshed: 2026-07-23T01:59:16Z · projected from 582 source nodes_
...
| domains/engineering | maturing | domains/engineering/ | 2h ago | deferred-work-suggestion-contract |
...
- **"Durable Attention — Project Mail, Personal Focus, and Explicit Promotion"** (surface: core, domains/engineering, serve) — 3/7 specs done
...
- **(unassigned)** — tracker-source-reconciliation, tracker-project-snapshot-contract, tracker-source-fidelity-and-evidence, brokered-tracker-agent-access, jira-import-per-type-filter-and-body-parity
