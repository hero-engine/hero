...
_Last refreshed: 2026-08-23T16:07:52Z · projected from 667 source nodes_

## Surfaces

| Surface | Stage | Path(s) | Last touched | Driver spec |
|---|---|---|---|---|
| core | maturing | cmd/, internal/ | 22m ago | hero-runner |
...
- **"Hero v0.34 Public Release Readiness"** (surface: core, serve) — 1/12 specs done
...
- **(unassigned)** — hero-public-truth-baseline, dual-mode-pm-qa-capability-packs, qa-public-pack, pm-public-pack, install-upgrade-contract-coverage, single-source-install
...
- Projection generation: 1ms · Source nodes: 667
