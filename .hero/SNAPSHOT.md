...
_Last refreshed: 2026-07-09T18:28:58Z · projected from 388 source nodes_

## Surfaces

| Surface | Stage | Path(s) | Last touched | Driver spec |
|---|---|---|---|---|
| core | building | cmd/, internal/ | <1m ago | flat-named-spec-discovery |
| docs | concept | web/docs/ | — | — |
| domains/chat | concept | domains/chat/ | — | — |
| domains/engineering | maturing | domains/engineering/ | 17h ago | harness-agnosticism-sweep |
...
- **Content Remediation — Audit Follow-Through Across Packs, Gates, and Harnesses** (surface: core, domains/engineering) — 2/4 specs done
...
- **(unassigned)** — mock-tracker-server, gitlab-tracker-support, hero-content-audit, cev2-corpus-reconcile-to-v3, team-oauth, tracker-fixtures
- **core** — priority-conflict-aware-drive-selection, delivery-gate-consistency
- **domains/engineering** — core-commands-domain-neutral
...
- Specs covered: 176/362 (48%)
- Projection generation: 0ms · Source nodes: 388
