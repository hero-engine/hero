...
_Last refreshed: 2026-08-22T22:38:08Z · projected from 662 source nodes_
...
- **Hero Domains — Platform Architecture for Non-Engineering Verticals** (surface: core, domains/engineering, domains/pm, domains/sales) — 14/20 specs done
...
- **(unassigned)** — pm-public-pack, install-upgrade-contract-coverage, single-source-install
