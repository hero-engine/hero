...
The installed binary Codex runs (`/Users/developer/go/bin/hero`, `v0.25.0-dirty`, built the
...
1. `.codex/config.toml` — Codex spawns `/Users/developer/go/bin/hero mcp`, parent = Codex host.
