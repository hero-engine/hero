...
- This `hero` repository is open source under Apache-2.0 (`apache-license-status`, Class A, shipped).
...
- **Repository metadata:** Apache-2.0 and public-source language are accurate for this repository.
