...
- **Gherkin / EARS mixing inside one story.** Pick one shape per story. (`acceptance-criteria-gherkin` exists as an alternate AC skill — load it when the team prefers Given/When/Then, but don't blend.)
