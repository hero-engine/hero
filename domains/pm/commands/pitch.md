...
---
Route this pitch request to the `pitch-author` agent (P1). In v1, falls through to `prd-author` with the pitch template forced. Loads the `pitch-writing-shape-up` skill.
