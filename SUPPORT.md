...
Hero is maintained on a best-effort basis. There is no guaranteed response or
resolution time.

## Where to start

- Setup and first use: [Getting Started](GETTING-STARTED.md)
- Full reference: [docs.heroengine.ai](https://docs.heroengine.ai/)
- MCP integration: [MCP Setup](MCP-SETUP.md)
...
Security vulnerabilities and private conduct reports follow
